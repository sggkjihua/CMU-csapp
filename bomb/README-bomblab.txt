...
// 就是尽可能地猜中那个expected的string，才能使得那个boom不爆炸
...
machine code in each phase. 

The idea is to understand what each
assembly statement does, and then use this knowledge to infer the
defusing string. 

Students earn points for defusing phases, and they
...
handles all aspects of the Bomb Lab for you: 

Students download their
